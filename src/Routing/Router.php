...
class Router
{
    ...
    public function run(): void
    {
        ...
        if (isset($this->middlewares[$request_method])) {
            $response = $this->handleRouteMiddlewares($this->middlewares[$request_method]);
        ...
        if (isset($this->routes->getRoutes()[$request_method])) {
            $this->handleRoute($this->routes->getRoutes()[$request_method]);
