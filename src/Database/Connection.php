...
namespace Facile\Database;

use Facile\Database\Drivers\MySql;
use Facile\Database\Drivers\PostgreSql;
...
class Connection
{
    ...
    public function make(array $config)
    {
        try {
            ...
            $this->console->green("but you can still use Facile.\n");
        }
