...
namespace Facile\Database\Goku\Builder;

use Facile\Database\Goku\Model;
use Facile\Database\Migrations\Columns\Drivers\MysqlColumn;
use Facile\Database\Migrations\Columns\Drivers\PostgreSqlColumn;
use Facile\Database\Migrations\Constraints\Drivers\MySqlConstraint;
use Facile\Database\Migrations\Constraints\Drivers\PostgreSqlConstraint;
use Facile\Database\Migrations\Generator;
use Exception;
use PDO;
 ...
 *
 * @package Facile\Database\Goku\Builder
 */
class QueryBuilder
{
